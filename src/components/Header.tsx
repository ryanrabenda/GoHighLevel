...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50">
        ...
        <div className="wrap flex h-20 items-center justify-between md:h-24">
          ...
          <div className="hidden items-center gap-4 lg:flex">
            <a
              ...
              className="font-display text-lg font-semibold text-forest hover:text-oxblood"
            >
              {company.phone}
            </a>
            <a
              href="#contact"
              className="rounded-full bg-forest px-5 py-2.5 font-label text-sm font-semibold uppercase tracking-wide text-cream transition-colors hover:bg-oxblood"
            >
              Request a Quote
            </a>
          </div>
      ...
      <div
        id="mobile-nav"
        className={`fixed inset-0 top-20 z-40 bg-forest transition-opacity duration-300 lg:hidden ${
